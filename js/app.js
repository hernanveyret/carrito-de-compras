...
const articulos = [
    {
      ...
      marca:'Jaguar',
      precio:3500,
      imagen:'img/productos/jaguar/320/320-black.png',
      color: 'Black',
      idUno: '320black',
      idDos: 'id320black',
      otrosColores: [
        {id: '1.1', nInicio: 34, nFinal: 47, imagen: 'img/productos/jaguar/320/320-blanca.png', color: 'Blanco',idUno:'320blanco',idDos:'id320blanco'},
        {id: '1.2', nInicio: 34, nFinal: 47, imagen: 'img/productos/jaguar/320/320-jean.png', color: 'Jean',idUno:'320jean',idDos:'id320jean'},
        {id: '1.3', nInicio: 34, nFinal: 47, imagen: 'img/productos/jaguar/320/320-negro.png', color: 'Negro',idUno:'320negro',idDos:'id320negro'},
        {id: '1.4', nInicio: 34, nFinal: 47, imagen: 'img/productos/jaguar/320/320-rojo.png', color: 'Rojo',idUno:'320rojo',idDos:'id320rojo'},
      ]
    },
    {
      id: 2,
      ...
      marca: 'Jaguar',
      precio: 1900,
      imagen: 'img/productos/jaguar/128/128-rosa.png',
      color: 'Rosa',
      idUno: '128/1rosa',
      idDos: 'id1281rosa',
      otrosColores: [
        {id: '2.1', nInicio: 19, nFinal: 26, imagen: 'img/productos/jaguar/128/128-jean.png', color: 'Jean',idUno:'128/1jean',idDos:'id1281jean'}
      ]
    },
    {
      id: 3,
    ...
    },
    {
      ...
      marca: 'Tridy',
      precio: 2500,
      imagen: 'img/productos/tridy/1153-blanca.png',
      color: 'Blanco',
      idUno: '1153blanca',
      idDos: 'id1153blanca',
      otrosColores: [
        {id: '4.1', nInicio: 19, nFinal: 26, imagen: 'img/productos/tridy/1153-negro.png', color: 'Negro',idUno:'1153negro',idDos:'id1153negro'}
      ]
    },
    {
      id: 5,
    ...
    },
    {
      ...
      marca: 'Growing',
      precio: 5400,
      imagen: 'img/productos/growing/609platagrowing.png',
      color: 'Plata',
      idUno: '609plata',
      idDos: 'id609plata',
      otrosColores: [
        {id: '7.1', nInicio: 35, nFinal: 40, imagen: 'img/productos/growing/609orogrowing.png', color: 'Oro',idUno:'609oro',idDos:'id609oro'},
        {id: '7.2', nInicio: 35, nFinal: 40, imagen: 'img/productos/growing/609negrogrowing.png', color: 'Negro',idUno:'609negro',idDos:'id609negro'},
      ]
    },
    {
      id: 8,
    ...
    },
    {
      ...
      marca: 'Savage',
      precio: 7400,
      imagen: 'img/productos/savage/lr26blanco.png',
      color: 'Blanco',
      idUno: 'lr16blanco',
      idDos: 'idlr16blanco',
      otrosColores: [
        {id: '9.1', nInicio: 35, nFinal: 40, imagen: 'img/productos/savage/lr16negro.png', color: 'Negro',idUno:'lr16negro',idDos:'idlr16negro'},
      ]
    },
    {
      id: 10,
    ...
    },
    {
      ...
      idDos: 'idp11azul',
      otrosColores: [
        {id: '11.1', nInicio: 19, nFinal: 26, imagen: 'img/productos/jamaiquina/p1fuxiajamaiquina.png', color: 'Fuxia',idUno:'p1/1fuxia',idDos:'idp11fuxia'},
        {id: '11.2', nInicio: 19, nFinal: 26, imagen: 'img/productos/jamaiquina/p1negrojamaiquina.png', color: 'Negro',idUno:'p1/1negro',idDos:'idp1/1negro'},
        {id: '11.3', nInicio: 19, nFinal: 26, imagen: 'img/productos/jamaiquina/p1rosajamaiquina.png', color: 'Rosa',idUno:'p1/1rosa',idDos:'idp1/1rosa'},
      ]
    },
    {
      id: 12,
      ...
      idDos: 'idp2fuxia',
      otrosColores: [
        {id: '12.1', nInicio: 27, nFinal: 34, imagen: 'img/productos/jamaiquina/p1azuljamaiquina.png', color: 'Azul',idUno:'p1azul',idDos:'idp1azul'},
        {id: '12.2', nInicio: 27, nFinal: 34, imagen: 'img/productos/jamaiquina/p1negrojamaiquina.png', color: 'Negro',idUno:'p1negro',idDos:'idp1negro'},
        {id: '12.3', nInicio: 27, nFinal: 34, imagen: 'img/productos/jamaiquina/p1rosajamaiquina.png', color: 'Rosa',idUno:'p1rosa',idDos:'idp1rosa'},
      ]
    },
    {
      id: 13,
      ...
      idDos: 'id20102rosa',
      otrosColores: [
        {id: '13.1', nInicio: 35, nFinal: 44, imagen: 'img/productos/cromic/2010-negro.png', color: 'Negro',idUno:'2010negro',idDos:'id2010negro'}
      ]
    },
    {
      id: 14,
    ...
    idDos: 'id404Donkeyaz',
    otrosColores: [
      {id: '16.1', nInicio: 39, nFinal: 45, imagen: 'img/productos/Donkey/404Donkeyne.png', color: 'Negro',idUno:'404negro',idDos:'id404negro'}
    ]
  },
  {
    id: 17,
    ...
    idDos: 'id6700negro',
    otrosColores: [
      {id: '17.1', nInicio: 35, nFinal: 40, imagen: 'img/productos/proforce/6700azulproforce.png', color: 'Azul',idUno:'6700azul',idDos:'id6700azul'}
    ]
  },
  {
    id: 18,
    ...
    idDos: 'id1023negro',
    otrosColores: [
      {id: '18.1', nInicio: 35, nFinal: 44, imagen: 'img/productos/action/1023azulaction.png', color: 'Azul',idUno:'1023azul',idDos:'id1023azul'}
    ]
  },
]
